package com.lp.dingding.message.util;
...
public class DingDingHttpUtils {
     ...
     * @return 响应报文
     */
    public static String sendPostByMap(String url, Map<String, Object> json) {
        Map<String, String> headParam = new HashMap<>(1);
        headParam.put("Content-type", "application/json;charset=UTF-8");
        return sendPost(url, json, headParam);
    }
